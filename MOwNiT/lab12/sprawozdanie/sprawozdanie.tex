...
Kluczową zaletą metody niejawnej jest \textbf{bezwarunkowa stabilność} -- można stosować dowolnie duże $\Delta t$. W obliczeniach użyto $\Delta t = 0{,}0013$ (ten sam krok, który powodował eksplozję w metodzie jawnej) -- rozwiązanie jest fizycznie poprawne i stabilne, co przedstawia Wykres~\ref{fig:wykres7}.
...
\begin{table}[H]
  ...
  \begin{tabular}{lcc}
    ...
    \midrule
    Stabilność & $r \le 0{,}5$ wymagane & bezwarunkowa \\
