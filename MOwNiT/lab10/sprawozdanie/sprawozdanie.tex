...
\title{
  ...
  \large Laboratorium 10: Równania różniczkowe zwyczajne, część II
}
...
% ============================================================
\section{Zadanie 1: Układ trzech ciał (CR3BP)}
% ============================================================

\subsection{Zadanie 1(a): Implementacja metod numerycznych}
...
\subsection{Zadanie 1(b): Mapa układu}
...
\subsection{Zadanie 1(c): Trajektoria w układzie synodycznym}
...
\subsection{Zadanie 1(d): Trajektoria w układzie inercjalnym}
...
\subsection{Zadanie 1(e): Prędkość w układzie inercjalnym}
...
\subsection{Zadanie 1(f): Energia kinetyczna i potencjalna}
...
\subsection{Zadanie 1(g): Całka Jacobiego}
