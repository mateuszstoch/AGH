...
--zadanie 4
select top 1 e.FirstName ,e.LastName ,count(*) from Employees e 
inner join orders o on o.EmployeeID = e.EmployeeID and year(o.OrderDate) = '1997'
group by e.EmployeeID ,e.FirstName ,e.LastName 
order by count(*) desc

--zadanie 5
select top 1 e.FirstName ,e.LastName, round(sum(od.Quantity*od.UnitPrice *(1- od.Discount)),2) as 'Wartosc zamowien' from Employees e 
inner join orders o on o.EmployeeID = e.EmployeeID and year(o.OrderDate) = '1997'
inner join [Order Details] od on od.OrderID  = o.OrderID 
group by e.EmployeeID ,e.FirstName ,e.LastName 
order by 'Wartosc zamowien' desc